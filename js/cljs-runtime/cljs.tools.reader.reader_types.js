...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_39146 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_39146(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_39147 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_39147(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39150 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39150(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39151 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39151(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39152 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39152(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39153 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39153(reader);
}
});
...
var G__39215 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__39216 = s.append(c);
c = G__39215;
s = G__39216;
continue;
}
