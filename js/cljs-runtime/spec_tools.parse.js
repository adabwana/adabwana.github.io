...
var fexpr__45290 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__45290.cljs$core$IFn$_invoke$arity$1 ? fexpr__45290.cljs$core$IFn$_invoke$arity$1(type) : fexpr__45290.call(null, type));
});
...
var G__45299 = spec_tools.impl.normalize_symbol(x);
var G__45300 = null;
var G__45301 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45299,G__45300,G__45301) : spec_tools.parse.parse_form.call(null, G__45299,G__45300,G__45301));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__45302 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__45303 = x;
var G__45304 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45302,G__45303,G__45304) : spec_tools.parse.parse_form.call(null, G__45302,G__45303,G__45304));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__45361 = cljs.spec.alpha.form(x);
var G__45362 = options;
x = G__45361;
options = G__45362;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__45305 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__45306 = null;
var G__45307 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45305,G__45306,G__45307) : spec_tools.parse.parse_form.call(null, G__45305,G__45306,G__45307));
} else {
...
var G__45310 = parse_data;
var G__45310__$1 = (((G__45310 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__45310));
var G__45310__$2 = (((G__45310__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__45310__$1));
var G__45310__$3 = (((G__45310__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__45310__$2));
var G__45310__$4 = (((G__45310__$3 == null))?null:cljs.core.seq(G__45310__$3));
if((G__45310__$4 == null)){
return null;
} else {
return cljs.core.set(G__45310__$4);
}
}
});
...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45313 = cljs.core.get_global_hierarchy;
return (fexpr__45313.cljs$core$IFn$_invoke$arity$0 ? fexpr__45313.cljs$core$IFn$_invoke$arity$0() : fexpr__45313.call(null, ));
})());
...
var map__45330 = spec_tools.impl.parse_keys(form);
var map__45330__$1 = cljs.core.__destructure_map(map__45330);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45330__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45330__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45330__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45330__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45330__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__45331 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__45331__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = req;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45331,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__45331);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45331__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__45331__$1;
}
}));
...
var vec__45332 = multi_spec_form;
...
var _ = first__45334;
var first__45334__$1 = cljs.core.first(seq__45333__$1);
var seq__45333__$2 = cljs.core.next(seq__45333__$1);
var multi_method_symbol = first__45334__$1;
var ___$1 = seq__45333__$2;
var form = vec__45332;
var temp__5823__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (v){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__45335){
var vec__45336 = p__45335;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45336,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45336,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__45340_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45340_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45341_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45341_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__45342_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__45342_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45343_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__45343_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__45344 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__45344__$1 = cljs.core.__destructure_map(map__45344);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45344__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__45346 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__45346__$1 = cljs.core.__destructure_map(map__45346);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45346__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__45347,options){
var vec__45348 = p__45347;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45348,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45348,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45348,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__45352,options){
var vec__45353 = p__45352;
var seq__45354 = cljs.core.seq(vec__45353);
var first__45355 = cljs.core.first(seq__45354);
var seq__45354__$1 = cljs.core.next(seq__45354);
var ___$1 = first__45355;
var values = seq__45354__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45351_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45351_SHARP_,options);
}),values);
...
var type_priority = (function (p1__45356_SHARP_){
var G__45359 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__45358 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__45356_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45357_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__45357_SHARP_,options);
}),cljs.core.rest(form))));
}));
