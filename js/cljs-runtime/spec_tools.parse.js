...
var fexpr__45169 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__45169.cljs$core$IFn$_invoke$arity$1 ? fexpr__45169.cljs$core$IFn$_invoke$arity$1(type) : fexpr__45169.call(null, type));
});
...
var G__45186 = spec_tools.impl.normalize_symbol(x);
var G__45187 = null;
var G__45188 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45186,G__45187,G__45188) : spec_tools.parse.parse_form.call(null, G__45186,G__45187,G__45188));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__45189 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__45190 = x;
var G__45191 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45189,G__45190,G__45191) : spec_tools.parse.parse_form.call(null, G__45189,G__45190,G__45191));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__45249 = cljs.spec.alpha.form(x);
var G__45250 = options;
x = G__45249;
options = G__45250;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__45192 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__45193 = null;
var G__45194 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__45192,G__45193,G__45194) : spec_tools.parse.parse_form.call(null, G__45192,G__45193,G__45194));
} else {
...
var G__45196 = parse_data;
var G__45196__$1 = (((G__45196 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__45196));
var G__45196__$2 = (((G__45196__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__45196__$1));
var G__45196__$3 = (((G__45196__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__45196__$2));
var G__45196__$4 = (((G__45196__$3 == null))?null:cljs.core.seq(G__45196__$3));
if((G__45196__$4 == null)){
return null;
} else {
return cljs.core.set(G__45196__$4);
}
}
});
...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45197 = cljs.core.get_global_hierarchy;
return (fexpr__45197.cljs$core$IFn$_invoke$arity$0 ? fexpr__45197.cljs$core$IFn$_invoke$arity$0() : fexpr__45197.call(null, ));
})());
...
var map__45209 = spec_tools.impl.parse_keys(form);
var map__45209__$1 = cljs.core.__destructure_map(map__45209);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45209__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45209__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45209__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45209__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45209__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__45210 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__45210__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = req;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45210,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__45210);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45210__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__45210__$1;
}
}));
...
var vec__45211 = multi_spec_form;
...
var _ = first__45213;
var first__45213__$1 = cljs.core.first(seq__45212__$1);
var seq__45212__$2 = cljs.core.next(seq__45212__$1);
var multi_method_symbol = first__45213__$1;
var ___$1 = seq__45212__$2;
var form = vec__45211;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__45216){
var vec__45217 = p__45216;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45217,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45217,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__45222_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45222_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45224_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45224_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__45231_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__45231_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45232_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__45232_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__45233 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__45233__$1 = cljs.core.__destructure_map(map__45233);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45233__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__45234 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__45234__$1 = cljs.core.__destructure_map(map__45234);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45234__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__45235,options){
var vec__45236 = p__45235;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45236,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45236,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45236,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__45240,options){
...
var ___$1 = first__45243;
var values = seq__45242__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45239_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__45239_SHARP_,options);
}),values);
...
var type_priority = (function (p1__45244_SHARP_){
var G__45247 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__45246 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__45244_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45245_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__45245_SHARP_,options);
}),cljs.core.rest(form))));
}));
