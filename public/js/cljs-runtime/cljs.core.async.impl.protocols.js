...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28334 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28334(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28368 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28368(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28389 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28389(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28400 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28400(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28412 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28412(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28431 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28431(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28440 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28440(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28483 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28483(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28517 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28517(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28535 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28535(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28541 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28541(b);
}
});
