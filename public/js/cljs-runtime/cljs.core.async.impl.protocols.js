...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28396 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28396(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28417 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28417(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28459 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28459(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28470 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28470(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28495 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28495(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28520 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28520(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28543 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28543(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28585 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28585(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28627 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28627(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28656 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28656(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28661 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28661(b);
}
});
