...
;; Current teaching work at Hudson Memorial School (US-03; reused by US-04).
...
;; Top-rated student web-design projects by year then trimester (US-03).
;; Canonical source: docs/user-stories/student-highlights-source.md
